          ...
          <div class="row bar mb-0">
            <div id="customer-orders" class="col-md-9">
              <p class="text-muted lead">
              	안녕하세요, ${memberModel.member_name} 회원님 <br/> 
              	최근 예약목록 외 전체 예약 내역은 <a href="myReservList.yolo">내 예약목록</a>에서 확인하실 수 있습니다.</p>
                    ...
                    <tbody>
                    	<c:choose>
                    		<c:when test="${fn:length(reservList) <= 0}">
                    			<tr>
                    				<td colspan="8" align="center">예약 내역이 없습니다.</td>
                    		</c:when>
                    		<c:otherwise>
              ...
              <div class="panel panel-default sidebar-menu">
                ...
                <div class="panel-body">
                  <ul class="nav nav-pills flex-column text-sm">
                    <li class="nav-item"><a href="myPage.yolo" class="nav-link active"><i class="fa fa-list"></i> 마이페이지</a></li>
